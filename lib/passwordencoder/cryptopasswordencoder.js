/**
 * A PasswordEncoder that encodes a given password using the crypto library.
 * The algorithm to use can be any supported by crypto.  An optional salt
 * can be provided to encode with the password.
 */
